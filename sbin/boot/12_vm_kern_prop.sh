...
echo "50" > /proc/sys/vm/dirty_background_ratio      # flush pages later (default 5% active mem)
...
echo -n "VM: check /proc/sys/swappiness :";cat /proc/sys/vm/swappiness                   
echo -n "VM: check dirty_writeback_centisecs :";cat /proc/sys/vm/dirty_writeback_centisecs
echo -n "VM: check dirty_expire_centisecs: ";cat /proc/sys/vm/dirty_expire_centisecs    
echo -n "VM: check proc/sys/vm/dirty_background_ratio: ";cat /proc/sys/vm/dirty_background_ratio
echo -n "VM: check /proc/sys/vm/dirty_ratio :";cat /proc/sys/vm/dirty_ratio       
echo
